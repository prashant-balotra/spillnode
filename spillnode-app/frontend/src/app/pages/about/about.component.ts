  ...
  template: `
    <section class="max-w-4xl mx-auto px-4 sm:px-6 py-20">
      ...
      <h1 class="font-display text-4xl sm:text-5xl font-extrabold mt-3 leading-tight">
        Hey, I'm the developer behind <span class="bg-accent text-ink-900 px-2 -rotate-1 inline-block">Spillnode</span>
      </h1>

      <div class="prose-content mt-8 text-lg">
        <p>
          Spillnode started as a YouTube channel for sharing what I learn while shipping real software —
